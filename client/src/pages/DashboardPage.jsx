  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mt-1">System overview and key metrics</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="card p-5 flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-bold text-slate-800">{done}</p>
        ...
        <div className="card p-5 flex items-center gap-3">
          ...
          <div>
            <p className="text-xl font-bold text-slate-800">{waitingParts}</p>
            <p className="text-xs text-slate-500">Waiting Parts</p>
          </div>
        </div>
        <div className="card p-5 flex items-center gap-3">
          <CalendarDaysIcon className="w-5 h-5 text-emerald-600" />
          <div>
            <p className="text-xl font-bold text-slate-800">{readyPickup}</p>
            <p className="text-xs text-slate-500">Ready Pickup</p>
          </div>
        </div>
      </div>

      {/* Revenue Section */}
      <div className="card p-6 border-l-4 border-brand-500 bg-gradient-to-r from-brand-50 to-transparent">
        <h2 className="font-semibold text-slate-800 text-lg">Total Revenue (Completed Bookings)</h2>
        <p className="text-4xl font-extrabold text-brand-600 mt-2">Rp {stats.total_revenue?.toLocaleString('id-ID')}</p>
        <p className="text-xs text-slate-500 mt-2">Powered by itemized billing engine.</p>
      </div>
    </div>
  )
}
