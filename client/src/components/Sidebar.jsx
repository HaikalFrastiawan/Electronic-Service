  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-slate-200 flex flex-col shrink-0">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-100">
        ...
        <div>
          <p className="font-bold text-sm text-slate-800 leading-none">AYOO SERVIS</p>
      ...
      <div className="px-3 py-4 border-t border-slate-100">
        <div className="flex flex-col gap-2 px-3 py-2 mb-4">
          ...
          <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-brand-50 text-brand-600 border border-brand-200 uppercase w-fit">
            {user?.role}
          </span>
        </div>
        <button 
